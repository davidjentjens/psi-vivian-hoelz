      ...
      <div className="mx-auto max-w-3xl px-6 py-24 md:py-28">
        ...
        <div className="rounded-2xl bg-navy px-8 py-10 text-white md:px-12">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <a
              href={FORM_URL}
              className="inline-flex items-center justify-center gap-2 rounded-full bg-gold px-6 py-3 font-body text-sm font-semibold tracking-wide text-white transition-colors hover:bg-gold-hover"
            >
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-full border border-white/25 px-6 py-3 font-body text-sm font-semibold tracking-wide text-white transition-colors hover:bg-white/10"
            >
              Falar pelo WhatsApp
